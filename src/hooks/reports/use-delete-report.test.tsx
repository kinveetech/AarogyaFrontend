...
const reportOne = { id: 'r1', title: 'Report 1', reportType: 'blood_test' as const, status: 'validated' as const, labName: null, highlightParameter: null, createdAt: '2025-01-01T00:00:00Z' }
const reportTwo = { id: 'r2', title: 'Report 2', reportType: 'radiology' as const, status: 'uploaded' as const, labName: null, highlightParameter: null, createdAt: '2025-01-02T00:00:00Z' }
